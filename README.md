...
Перед початком роботи було проаналізовано три вакансії **Machine Learning Engineer** та **Data Scientist** для визначення найбільш затребуваних навичок і вибору теми проєкту.

Аналіз показав, що роботодавці найчастіше очікують від кандидатів володіння **Python**, навичок підготовки та аналізу даних, побудови й оцінювання моделей машинного навчання, застосування **Feature Engineering**, використання бібліотек **scikit-learn** і **PyTorch**, роботи з методами **Natural Language Processing (NLP)**, а також знання системи контролю версій **Git**.

На основі цього аналізу було обрано задачу **аналізу тональності текстових відгуків (IMDb Movie Reviews Sentiment Analysis)**, оскільки вона дозволяє продемонструвати більшість ключових компетенцій, затребуваних у вакансіях Machine Learning Engineer та Data Scientist: попередню обробку тексту, побудову й порівняння моделей машинного навчання, підбір гіперпараметрів, оцінювання якості моделей та аналіз отриманих результатів.
...
Під час EDA було виявлено дублікати відгуків. Вони були видалені для запобігання **data leakage** між тренувальною та валідаційною вибірками та отримання більш об'єктивної оцінки якості моделей. Після чого було проведено аналіз розподілу класів, довжини текстів та найбільш важливих слів.
...
## 6. Підхід до розв'язку та інструменти
...
![Top_20](reports/Top_20_Features.png)
...
## 9. Як запустити проєкт (Installation & Usage)
